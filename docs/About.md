...
2.  **Safety**: We use official Microsoft APIs (PowerShell, DISM, Winget) rather than hacking registry keys blindly.
3.  **Modernity**: Built strictly for **PowerShell 7.5+**, leveraging new features like `clean` blocks, parallel loops, and improved security.
